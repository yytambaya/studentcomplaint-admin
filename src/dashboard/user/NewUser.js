...
const NewUser = ({setPage, setLastPage, lastPage}) => {
    ...
    const [error, setError] = useState([{field: "name", msg:""}, {field: "email", msg:""}, {field: "phoneNumber", msg:""}, {field: "regNumber", msg: ""}, {field: "hostelId", msg: ""}, {field: "password", msg:""}, {field: "status", msg:""} ]);
    ...
    const createUser = async () => {
        ...
        if(name_val && email_val && phoneNumber_val && regNumber_val && hostelId_val && password_val  && status_val && at_val && ui_val && un_val){
            //alert("going")
            setAction("Loading...")
            const url = `${getAPIBaseURL()}/v1/admin/student/new`;
            ...
            const data = {name, email, phoneNumber, regNumber, hostelId, password, status: statusCode};
    ...
    return(
        ...
        <div class="mx-5 md:mx-20 mt-10">
            ...
            <div class="mb-6">
                ...
                <input onChange={(e) => setRegNumber(e.target.value)} type="text" id="name" class="text-lg outline-none focus:border-gray-400 border-2  w-full px-4 py-2" placeholder="u19cs1004" required=""/>
            ...
            <div class="mb-6">
                ...
                <select onChange={(e) => setHostelId(e.target.value)} type="text" id="name" class="text-lg outline-none focus:border-gray-400 border-2  w-full px-4 py-2" placeholder="Ribadu" required="">
                    <option>Select hostel</option>
                    {hostels?.map((hos, i) =>
                        <option value={hos._id}>{hos.name}</option>
                    )}
                </select>    
